...
from core.models import Contact, Destination, State, Slider,News,Dataset,SubscribedUsers,RegionDataset
...
@admin.register(RegionDataset)
class RegionDatasetAdmin(admin.ModelAdmin):
